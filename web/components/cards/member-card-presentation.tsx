...
export function MemberCardPresentation({
  ...
  return (
    <div className={cn("grid w-full gap-6 lg:grid-cols-2 lg:gap-8", className)}>
      <figure className="mx-auto w-full max-w-[32rem]">
        {showLabels && (
          <figcaption className="mb-2 flex items-center justify-between text-[11px] font-semibold tracking-[0.16em] text-slate-400 uppercase">
            <span>Recto</span>
      ...
      <figure className="mx-auto w-full max-w-[32rem]">
        {showLabels && (
          <figcaption className="mb-2 text-[11px] font-semibold tracking-[0.16em] text-slate-400 uppercase">
            Verso
          </figcaption>
        )}
